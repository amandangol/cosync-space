  ...
  return (
    <div className="flex min-h-screen bg-black text-white">
      ...
      <div className="flex w-full items-center justify-center bg-white px-8 lg:w-1/2">
        ...
        >
          <h2 className="mb-2 text-center text-4xl font-bold text-gray-900">Welcome Back!</h2>
          <p className="text-center text-gray-600 mb-8">We're excited to see you again. Let's get you signed in.</p>
          <SignIn
            appearance={{
              elements: {
                formButtonPrimary: 
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600 mb-4">New to CoSyncSpace?</p>
            <Link 
              href="/sign-up" 
