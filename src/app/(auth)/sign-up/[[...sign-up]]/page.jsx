  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      ...
      <div className="flex w-full items-center justify-center bg-gradient-to-b from-gray-800 to-gray-900 px-8 lg:w-1/2">
        ...
        >
          <h2 className="mb-2 text-center text-4xl font-bold text-white">Create Account</h2>
          <p className="text-center text-gray-300 mb-8">Join CoSyncSpace and elevate your teamwork.</p>
          <SignUp
            appearance={{
              elements: {
                formButtonPrimary: 
